            ...
            <div className="HomeComponent">
                <div className="menu">
                    <div className="menu-content">
                        ...
                        <div style={{ paddingTop: '10px' }}>Profile</div>
                        <div className="menu-item">
                            ...
                            <div className="tech">
                                <div className="tech-block">
                                    ...
                                    <div className="tech-name-group">
                                        ...
                                        <div className="tech-name" > <img width="20px" height="20px" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Ficonscout.com%2Ficons%2Fleetcode&psig=AOvVaw3EacWZU19wRaw-dtMJLw90&ust=1706809662926000&source=images&cd=vfe&opi=89978449&ved=0CBMQjRxqFwoTCPih486XiIQDFQAAAAAdAAAAABAE" />JavaScript.js</div>
