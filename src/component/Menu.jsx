        ...
        <>
            <div className="menu">
                <div className="menu-content">
                        <div className="menu-item" onClick={()=>{scrollTo("Home-scroll")}}>
                            <Home />
                            Home
                        </div>

                    
                        <div className="menu-item" onClick={()=>{scrollTo("mega-project-scroll")}}>
                            <FolderOpenDot />
                            Mega project
                        </div>
                    
                        <div className="menu-item" onClick={()=>{scrollTo("experience-scroll")}}>
                             <img color="#8b8a91" width="20px" src={experience} alt="" />
                            Experience
                        </div>

                    <div className="menu-item"  onClick={()=>{scrollTo("tech-scroll")}} >
                        <Cpu />
                        Technology
                    </div>

                    
                    <div className="menu-item"  onClick={()=>{scrollTo("mini-project-scroll")}} >
                            <SwatchBook />
                            Mini Project
                        </div>
